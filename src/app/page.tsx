    ...
    <div className="min-h-dvh bg-omniv-black text-omniv-text">
      <header className="mx-auto flex max-w-5xl items-center justify-between px-4 py-5">
        ...
        <div className="flex gap-2">
          <Link href="/login">
            <Button variant="outline" className="h-9">Log in</Button>
          </Link>
          <Link href="/signup">
      ...
      <main className="mx-auto max-w-3xl px-4 pb-20 pt-10 text-center">
        ...
        <h1 className="mt-3 text-4xl font-semibold tracking-tight sm:text-5xl">
          ...
          <span className="block text-omniv-gold"> Verify demand. Then spend.</span>
        </h1>
        <p className="mx-auto mt-4 max-w-xl text-[15px] leading-relaxed text-omniv-text-secondary">
          Omniv captures city + intent on your Fan Gate, scores real market demand,
          and ranks the next move — open a room, get paid, ask Ziki (your visual Chief
          Strategic Officer trained on artist management).
        </p>
        <div className="mt-8 flex flex-wrap justify-center gap-3">
          ...
          <Link href="/blog">
            <Button variant="outline" className="h-11 px-6">Read the playbooks</Button>
          </Link>
        </div>
