      ...
      <main className="mx-auto max-w-lg px-4 pb-32 pt-5 md:max-w-2xl">
        ...
        {step === "form" && pubType && (
          <form onSubmit={onSubmit} className="space-y-5">
              ...
              <>
                <Field label="Article title *">
                  <input
                    ...
                    placeholder="Why African language AI is becoming an infrastructure problem"
                    className={inputCls}
                  />
                </Field>
                <CoverZone label="Change cover image" />
                <Field label="Article body *">
                  ...
                  <textarea
                    ...
                    rows={8}
                    placeholder="African language models aren't just about better translation — they're about building the infrastructure for Africa's digital future."
                    className={areaCls}
                  />
                </Field>
                <TagsField value={tags} onChange={setTags} />
                <input type="hidden" value={publisherName} />
            ...
            {pubType === "music" && (
              <>
                <div className="grid grid-cols-2 gap-3">
                  <CoverZone label="Change cover" tall />
                  <UploadZone
                    icon="♪"
                    title="Upload audio"
                    hint="Tap to upload · MP3, WAV, FLAC · Max 100MB"
                  />
                </div>
                ...
                <Field label="Description">
                  <textarea
                    ...
                    rows={3}
                    placeholder="A raw and emotional record about growth…"
                    className={areaCls}
                  />
                </Field>
            ...
            {pubType === "video" && (
              <>
                <CoverZone label="Change thumbnail" video />
                <Field label="Video title *">
                  <input
                    required
                    value={title}
                    onChange={(e) => setTitle(e.target.value)}
                    placeholder="Inside Lagos: The Next Wave of African Tech"
                    className={inputCls}
                  />
                </Field>
                <Field label="Description *">
                  <textarea
                    ...
                    onChange={(e) => setSummary(e.target.value)}
                    rows={3}
                    placeholder="A look at the founders, builders and investors…"
                    className={areaCls}
                  />
                </Field>
                <Field label="Publisher">
              ...
              <>
                ...
                <Field label="Title *">
                  <input
                    ...
                    value={title}
                    onChange={(e) => setTitle(e.target.value)}
                    placeholder="African Language Model Landscape 2026"
                    className={inputCls}
                  />
                </Field>
                <Field label="Abstract / Summary *">
                  <textarea
                    ...
                    onChange={(e) => setSummary(e.target.value)}
                    rows={4}
                    placeholder="This report maps the current state of African language models…"
                    className={areaCls}
                  />
                </Field>
            ...
            {pubType === "product" && (
              <>
                <CoverZone label="Change image" />
                <Field label="Product name *">
                  <input
                    required
                    value={title}
                    onChange={(e) => setTitle(e.target.value)}
                    placeholder="Nokanda API"
                    className={inputCls}
                  />
                </Field>
                <Field label="Short description *">
                  <textarea
                    ...
                    onChange={(e) => setSummary(e.target.value)}
                    rows={3}
                    placeholder="Access high-quality African language models via a simple API."
                    className={areaCls}
                  />
                </Field>
                <div>
              ...
              <>
                ...
                <Field label="Event name *">
                  <input
                    ...
                    value={title}
                    onChange={(e) => setTitle(e.target.value)}
                    placeholder="AfroTech Lagos 2026"
                    className={inputCls}
                  />
                </Field>
                <div className="grid grid-cols-2 gap-3">
                ...
                <Field label="Location *">
                  <input
                    ...
                    placeholder="Landmark Centre, Lagos, Nigeria"
                    className={inputCls}
                  />
                </Field>
                <Field label="Description *">
                  <textarea
                    ...
                    onChange={(e) => setSummary(e.target.value)}
                    rows={3}
                    placeholder="The biggest tech, innovation and culture event…"
                    className={areaCls}
                  />
                </Field>
              ...
              <>
                ...
                <Field label="Title *">
                  <input
                    ...
                    value={title}
                    onChange={(e) => setTitle(e.target.value)}
                    placeholder="Nokanda AI Partners with CloudNext"
                    className={inputCls}
                  />
                </Field>
                <Field label="Content *">
                  <textarea
                    ...
                    onChange={(e) => setBody(e.target.value)}
                    rows={5}
                    placeholder="We're excited to announce our partnership…"
                    className={areaCls}
                  />
                </Field>
                <Field label="Publisher *">
                ...
                <Field label="Optional CTA">
                  <div className="mt-1.5 flex gap-2">
                    <input
                      ...
                      placeholder="Read the full announcement"
              ...
              <>
                ...
                <Field label="Title *">
                  <input
                    ...
                    value={title}
                    onChange={(e) => setTitle(e.target.value)}
                    placeholder="Looking for Investment – African AI Startups"
                    className={inputCls}
                  />
                </Field>
                <div className="grid grid-cols-2 gap-3">
                ...
                <Field label="Description *">
                  <textarea
                    ...
                    onChange={(e) => setSummary(e.target.value)}
                    rows={3}
                    placeholder="We're investing in early-stage AI companies…"
                    className={areaCls}
                  />
                </Field>
                ...
                <Field label="Requirements">
                  <textarea
                    ...
                    rows={2}
                    placeholder="Active product or MVP · Strong founding team"
                    className={areaCls}
                  />
                </Field>
              </>
            ...
            {pubType === "file" && (
              <>
                <UploadZone
                  icon="↑"
                  title="Drop file here or tap to upload"
                  hint="PDF, DOCX, XLSX, ZIP etc. (Max 100MB)"
                />
                <Field label="File name *">
                  <input
                    ...
                    value={title}
                    onChange={(e) => setTitle(e.target.value)}
                    placeholder="Nokanda AI Developer Documentation"
                    className={inputCls}
                  />
                </Field>
                <Field label="Description">
                  <textarea
                    ...
                    onChange={(e) => setSummary(e.target.value)}
                    rows={3}
                    placeholder="Technical documentation for the Nokanda API…"
                    className={areaCls}
                  />
                </Field>
                <div className="grid grid-cols-2 gap-3">
            ...
            <div className="fixed inset-x-0 bottom-14 z-40 border-t border-white/5 bg-[#050505]/95 px-4 py-3 backdrop-blur-sm md:static md:border-0 md:bg-transparent md:px-0 md:py-0 md:backdrop-blur-none">
              <div className="mx-auto flex max-w-lg items-center gap-3 md:max-w-none">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="ml-auto h-11 min-w-[120px] rounded-full bg-omniv-gold px-8 text-[14px] font-semibold text-black shadow-lg shadow-omniv-gold/15 disabled:opacity-60"
                >
  ...
  return (
    <Field label="Tags">
      <input
        ...
        placeholder="AI, Africa, Technology"
        className={inputCls}
      />
...
function CoverZone({
  ...
  return (
    <div
      className={`relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-zinc-800 to-zinc-950 ${
