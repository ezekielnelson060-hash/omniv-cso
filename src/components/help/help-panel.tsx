...
const faqs = [
  {
    q: "Who is Ziki?",
    a: "Ziki is your visual Chief Strategic Officer — trained on artist management. Briefings, market demand reads, rooms, and ranked moves grounded in Artist Brain and your real fan data — not a generic chatbot.",
  },
  {
