        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          <div className="lg:col-span-1">
            ...
            <p className="mt-3 max-w-xs text-[13px] leading-relaxed text-zinc-500">
              Discovery network for the real world. Publish what exists. Find
              what has intent. Connect.
            </p>
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-[13px] text-zinc-500">
              ...
              <li>
                <Link href="/explore" className="hover:text-zinc-200">
                  Explore
                </Link>
              </li>
              <li>
                <Link href="/signup?from=publish" className="hover:text-zinc-200">
                  Publish
                </Link>
              </li>
              <li>
